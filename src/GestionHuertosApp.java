...
public class GestionHuertosApp {
    ...
    private void creaPlanDeCosecha() {
        ...
        System.out.print("Ingrese el precio base por kilo: ");
        ...
        boolean planCreado = control.createPlanCosecha(id, nombre, inicio, finalizacion, meta, precioBase, nombreHuerto, idCu);
        if (!planCreado) {
        ...
        System.out.print("Ingrese el número de cuadrillas: ");
        int nCuad = sc.nextInt();
        ...
        for (int i = 0; i < nCuad; i++) {
            ...
            sc.nextLine();
            String nombreCuadrilla = sc.nextLine();

            System.out.print("Rut supervisor: ");
            String rut = sc.next();

            boolean cuadrillaCreada = control.addCuadrillatoPlan(id, idCuadrilla, nombreCuadrilla, rut);
            if (cuadrillaCreada) {
